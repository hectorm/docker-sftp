...
m4_ifdef([[CROSS_ARCH]], [[FROM docker.io/CROSS_ARCH/alpine:latest]], [[FROM docker.io/alpine:latest]]) AS build
...
ARG BUSYBOX_TARBALL_CHECKSUM=0e4925392fd9f3743cc517e031b68b012b24a63b0cf6c1ff03cce7bb3846cc99
